...
export default function HostInfo({ details }) {
  console.log('HostInfodetails', details);
    ...
    <>
      ...
      >
        ...
        <DialogActions sx={{ justifyContent: 'center', mt: 2 }}>
          <Button variant="contained" color="primary" onClick={handleConfirmDeclineByHost} loading={declineLoading} loadingPosition="end" sx={{ textTransform: 'none', borderRadius: 2 }}>
            Yes, decline it!
          </Button>
      ...
      {lastBooking?.bookingStatus != 'DECLINED' ? (
        <Stack gap={1.5}>
          ...
          {lastBooking?.bookingType === 'REQUEST' && (
            <Button size="small" onClick={() => setOpenDeclineByHostDialog(true)} loading={declineLoading} loadingPosition="end" fullWidth variant="outlined" color="primary" sx={{ textTransform: 'none' }}>
              {trans('Decline')}
            </Button>
          )}
        </Stack>
