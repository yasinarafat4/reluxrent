...
const AmenitiesTypeCreateTitle = () => {
...
const AmenitiesTypeCreateActions = () => (
  <TopToolbar>
...
const AmenitiesTypeCreate = () => {
  return (
    <Create redirect="list" title={<AmenitiesTypeCreateTitle />} actions={<AmenitiesTypeCreateActions />}>
      <SimpleForm>
...
export default AmenitiesTypeCreate;
