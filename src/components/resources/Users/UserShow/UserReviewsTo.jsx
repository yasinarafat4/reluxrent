...
const UserReviewsTo = () => {
  const record = useRecordContext();
  console.log('UserReviewsTo', record);
  ...
  return (
    <List resource="reviews" filter={{ receiverId: userId }} actions={<UserReviewToActions />}>
      <Paper elevation={3}>
