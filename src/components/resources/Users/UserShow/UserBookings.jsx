...
const UserBookings = () => {
  ...
  return (
    <List resource="bookings" filter={{ guestId: userId }} filters={UserBookingFilters} actions={<UserBookingActions />} exporter={exporter}>
      <Table bulkActionButtons={false} rowSx={rowSx()} rowClick={'expand'} expand={<BookingsPanel />} expandSingle>
        {/* Id */}
