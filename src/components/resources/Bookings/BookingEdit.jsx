...
import BookingEditToolbar from './BookingEditToolbar';

const BookingEditTitle = () => {
  const appTitle = useDefaultTitle();
  const { defaultTitle } = useEditContext();
  return <title>{`${defaultTitle}-${appTitle}`}</title>;
};

const BookingEditActions = () => (
  <TopToolbar>
    <CloneButton />
...
const BookingEdit = () => {
  return (
    <Edit title={<BookingEditTitle />} actions={<BookingEditActions />} mutationMode="pessimistic">
