import { BooleanField, BulkDeleteButton, DataTable, DateField, TextField, useCreatePath } from 'react-admin';
...
export const CurrencyListDesktop = ({ selectedRow }) => {
  ...
  return (
    ...
    >
      ...
      <Column source="decimalPlaces" />
      <Column source="decimalSeparator" />
      <Column source="thousandSeparator" />
      <Column source="exchangeRate" />
      <Column source="status" field={BooleanField} />
      <Column source="defaultCurrency" field={BooleanField} />
