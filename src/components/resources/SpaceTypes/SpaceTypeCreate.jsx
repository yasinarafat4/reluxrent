...
const SpaceTypeCreate = () => {
  return (
    <Create redirect="list" title={<SpaceTypeCreateTitle />} actions={<SpaceTypeCreateActions />}>
      <SimpleForm>
...
export default SpaceTypeCreate;
