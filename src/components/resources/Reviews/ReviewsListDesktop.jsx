...
import { DataTable, FunctionField, ReferenceField, TextField, useRecordContext } from 'react-admin';
...
export const ReviewsListDesktop = () => {
  ...
  return (
    ...
    >
      ...
      <Column source="senderId" label="Sender Name">
        <ReferenceField source="senderId" reference="users">
          <TextField source="name" />
        </ReferenceField>
      </Column>
      <Column source="receiverId" label="Receiver Name">
      ...
      <Column source="propertyId" label="Property">
...
export default ReviewsListDesktop;
