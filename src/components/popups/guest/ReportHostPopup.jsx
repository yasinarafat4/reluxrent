...
export default function ReportHostPopup({ closeModal, showModal, popupData }) {
  ...
  return (
    ...
    >
      <Box>
        <DialogTitle>{trans('What\'s happening?')}</DialogTitle>
        <Typography marginLeft={3} variant="body2">
          {trans('This will only be shared with Reluxrent.')}
        </Typography>
      </Box>
