...
export default function CancelReservationPopup({ closeModal, showModal, popupData }) {
  ...
  return (
    ...
    >
      <DialogTitle>{trans('Cancel reservation?')}</DialogTitle>

      <DialogContent sx={{ pt: 2 }}>
        <Typography variant="body2" color="text.secondary">
          If you withdraw this pre-approval, Arafat won't be able to book Romantic Deluxe Room | Perfect for Couples from Aug 30 - 31 for $100 anymore.
        </Typography>
      </DialogContent>
