...
export default function ReportMessagePopup({ closeModal, showModal }) {
  ...
  return (
    ...
    >
      <Box>
        ...
        <Typography marginLeft={3} variant='body2'>This will only be shared with Reluxrent.</Typography>
      </Box>
      ...
      <DialogActions sx={{ p: 2 }}>
        <Button variant="contained" color="primary" onClick={() => console.log('Report clicked')} sx={{ textTransform: 'none' }}>
          Okay
        </Button>
      </DialogActions>
    </Dialog>
