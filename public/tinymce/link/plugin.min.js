...
!(function () {
      ...
      const n = { text: e.text, title: e.title },
        o = (e, o) => {
          ...
          return ((e, t, n, o) => {
            const r = o[t],
              l = e.length > 0;
            return void 0 !== r ? me(r, n).map((t) => ({ url: { value: t.value, meta: { text: l ? e : t.text, attach: g } }, text: l ? e : t.text })) : m.none();
          })(n.text, o, r, e);
        };
      return {
        onChange: (e, t) => {
    ...
    Oe = (e, t) =>
      ((e) => {
        ...
        const o = ((e, t) => {
          ...
          return { url: r, text: o, title: t.bind((e) => Ce(n, e, 'title')), target: l, rel: s, linkClass: i };
        })(e, t);
        return { anchor: o, catalogs: { targets: we(e), rels: ye(e, o.target), classes: be(e), anchor: ve(e), link: n }, optNode: t, flags: { titleEnabled: R(e) } };
      }),
    Se = (e) => {
      const t = ((e) => {
        const t = G(e);
  ...
  const Ne = (e, t) => {
    ...
    Be = (e) => {
      ...
      (((e, t) => {
        (e.ui.registry.addToggleButton('link', { icon: 'link', tooltip: 'Insert/edit link', shortcut: 'Meta+K', onAction: Te(e), onSetup: Pe(e) }),
          e.ui.registry.addButton('openlink', { icon: 'new-tab', tooltip: 'Open link', onAction: t.gotoSelectedLink, onSetup: De(e) }),
          e.ui.registry.addButton('unlink', { icon: 'unlink', tooltip: 'Remove link', onAction: () => oe(e), onSetup: De(e) }));
      })(e, t),
        ((e, t) => {
          (e.ui.registry.addMenuItem('openlink', { text: 'Open link', icon: 'new-tab', onAction: t.gotoSelectedLink, onSetup: De(e) }),
            e.ui.registry.addMenuItem('link', { icon: 'link', text: 'Link...', shortcut: 'Meta+K', onAction: Te(e), onSetup: Me(e) }),
            e.ui.registry.addMenuItem('unlink', { icon: 'unlink', text: 'Remove link', onAction: () => oe(e), onSetup: De(e) }));
        })(e, t),
        ((e) => {
          e.ui.registry.addContextMenu('link', { update: (t) => (e.dom.isEditable(t) ? (X(e.dom.getParents(t, 'a')) ? 'link unlink openlink' : 'link') : '') });
        })(e),
        ((e, t) => {
          const n = (t) => {
            ...
            commands: [
              {
                ...
                onAction: (t) => {
                  ...
                  (ne(e, { href: n, attach: g }, { href: n, text: o, title: m.none(), rel: m.none(), target: m.from(O(e)), class: m.none() }),
                    ((e) => {
    ...
    (((e) => {
      ...
      ((e) => {
        e.addCommand('mceLink', (t, n) => {
          !0 !== (null == n ? void 0 : n.dialog) && L(e) ? e.dispatch('contexttoolbar-show', { toolbarKey: 'quicklink' }) : Se(e);
        });
      })(e),
      Be(e),
      ((e) => {
