  ...
  t.add('visualblocks', (t, l) => {
    ...
    (((t, e, s) => {
      ...
      ((t, o) => {
        ...
        (t.ui.registry.addToggleButton('visualblocks', { icon: 'visualblocks', tooltip: 'Show blocks', onAction: e, onSetup: s(t, o), context: 'any' }),
          t.ui.registry.addToggleMenuItem('visualblocks', { text: 'Show blocks', icon: 'visualblocks', onAction: e, onSetup: s(t, o), context: 'any' }));
      })(t, a),
      ((t, s, l) => {
