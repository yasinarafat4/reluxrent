...
(function () {
  ...
  const isListInsideAnLiWithFirstAndLastNotListElement = (list) =>
    parent(list).exists(
      (parent) => isListItemNode(parent.dom) && firstChild(parent).exists((firstChild) => !isListNode(firstChild.dom)) && lastChild(parent).exists((lastChild) => !isListNode(lastChild.dom)),
    );
