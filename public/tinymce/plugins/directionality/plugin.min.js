...
!(function () {
  ...
  const m = (t) => (e) => ((t) => t.dom.nodeType)(e) === t,
    ...
    w = (t) => {
      ...
      return ((t) => {
        ...
        var o;
      })(d(e)).fold(() => o.body.contains(e), ((r = w), (i = p), (t) => r(i(t))));
      var r, i;
    },
    b = (t) =>
      'rtl' ===
      ((t, e) => {
        ...
        return '' !== r || w(t) ? r : ((t, e) => (((t) => void 0 !== t.style && i(t.style.getPropertyValue))(t) ? t.style.getPropertyValue(e) : ''))(o, e);
      })(t, 'direction')
        ? 'rtl'
        : 'ltr',
    S = (t, e) =>
  ...
  t.add('directionality', (t) => {
    (((t) => {
      ...
      ((t) => {
        (t.ui.registry.addToggleButton('ltr', { tooltip: 'Left to right', icon: 'ltr', onAction: () => t.execCommand('mceDirectionLTR'), onSetup: C(t, 'ltr') }),
          t.ui.registry.addToggleButton('rtl', { tooltip: 'Right to left', icon: 'rtl', onAction: () => t.execCommand('mceDirectionRTL'), onSetup: C(t, 'rtl') }));
      })(t));
  });
})();
