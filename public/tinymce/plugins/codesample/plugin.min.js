  ...
  const r = 'undefined' != typeof window ? window : Function('return this;')(),
    i = (function () {
      ...
      return (
        ...
        t.languages.insertBefore('c', 'function', { constant: /\b(?:EOF|NULL|SEEK_CUR|SEEK_END|SEEK_SET|__DATE__|__FILE__|__LINE__|__TIMESTAMP__|__TIME__|__func__|stderr|stdin|stdout)\b/ }),
            ...
            t.languages.markup.tag.inside['special-attr'].push({
              ...
              inside: {
                ...
                'attr-value': {
                  pattern: /=[\s\S]+/,
                  inside: {
                    value: { pattern: /(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/, lookbehind: !0, alias: [n, 'language-' + n], inside: t.languages[n] },
    ...
    p = (e) => {
      const t = ((e) =>
        ...
        n = ((r = t), ((e) => (0 < e.length ? a.some(e[0]) : a.none()))(r)).fold(
          () => '',
          (e) => e.value,
        );
      var r;
