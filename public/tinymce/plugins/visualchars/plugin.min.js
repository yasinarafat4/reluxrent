...
!(function () {
  ...
  const u = (t, e) => {
    ...
    M = (t) => '<span data-mce-bogus="1" class="mce-' + O[t] + '">' + t + '</span>',
    P = (t) => 'span' === t.nodeName.toLowerCase() && t.classList.contains('mce-nbsp-wrap'),
    _ = (t) => {
      const e = f(t);
    ...
    D = (t, e, n) => {
      ...
      return (
        u(r, (t) => {
          var r;
          (n && (P((r = t).dom) || !((t) => y(t) && 'false' === x(t))(r)) && e(t) && (o = o.concat([t])),
            (o = o.concat(
              D(
                t,
                e,
    ...
    H = (t, e) => {
      ...
      u(o, (e) => {
        ...
        if (P(r))
          ...
          const r = n.encode(null !== (o = f(e)) && void 0 !== o ? o : '').replace(j, M),
            s = n.create('div', {}, r);
          let a;
  ...
  t.add('visualchars', (t) => {
    ...
    return (
      ...
      ((t, e) => {
        ...
        (t.ui.registry.addToggleButton('visualchars', { tooltip: 'Show invisible characters', icon: 'visualchars', onAction: n, onSetup: U(t, e), context: 'any' }),
          t.ui.registry.addToggleMenuItem('visualchars', { text: 'Show invisible characters', icon: 'visualchars', onAction: n, onSetup: U(t, e), context: 'any' }));
      })(t, e),
      R(t, e),
      ((t, e) => {
        t.on('init', () => {
