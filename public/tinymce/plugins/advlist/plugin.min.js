...
!(function () {
  ...
  const c = (t) => (e) => i(e) && t.test(e.nodeName),
    ...
    v = (t, s, r, n, l, i) => {
      const c = { 'lower-latin': 'lower-alpha', 'upper-latin': 'upper-alpha', 'lower-alpha': 'lower-latin', 'upper-alpha': 'upper-latin' },
        h =
          ((g = (t) => {
  ...
  t.add('advlist', (t) => {
    t.hasPlugin('lists')
      ? (((t) => {
        ...
        ((t) => {
          (y(t, 'numlist', 'Numbered list', 'InsertOrderedList', 'OL', r(t)), y(t, 'bullist', 'Bullet list', 'InsertUnorderedList', 'UL', n(t)));
        })(t),
        ((t) => {
