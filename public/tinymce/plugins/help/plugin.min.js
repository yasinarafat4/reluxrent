...
!(function () {
  ...
  const n = (e) => {
      const n = new Date().getTime(),
        a = Math.floor((window.crypto.getRandomValues(new Uint32Array(1))[0] / 4294967295) * 1e9);
      ...
      const t = (e) => `<a data-alloy-tabstop="true" tabindex="-1" href="${e.url}" target="_blank" rel="noopener">${e.name}</a>`,
        ...
        a = (e) => {
          const t = ((e) => {
              const t = g(e.plugins),
                n = o(e),
                a = s(n) ? ['onboarding'] : n.concat(['onboarding']);
              return h(t, (e) => !(((e, t) => p.call(e, t))(a, e) > -1));
            })(e),
            a = d(
              y(t, (t) => n(e, t)),
            ...
            i = r.length,
            c = r.join('');
          return '<p><b>' + f.translate(['Plugins installed ({0}):', i]) + '</b></p><ul>' + c + '</ul>';
        },
        r = {
          type: 'htmlpanel',
          presets: 'document',
