      ...
      editor.ui.registry.addContextToolbar('quickblock', {
        predicate: (node) => {
          ...
          return (
            ...
            closest(sugarNode, 'table,[data-mce-bogus="all"]', isRoot).fold(() => closest$1(sugarNode, (elem) => name(elem) in textBlockElementsMap && editor.dom.isEmpty(elem.dom), isRoot), never)
          );
        },
